...
func easyjson9f04e93cDecodeGithubComKamaiuOandaGoModel1(in *jlexer.Lexer, out *PricingHeartbeat) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson9f04e93cEncodeGithubComKamaiuOandaGoModel1(out *jwriter.Writer, in PricingHeartbeat) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson9f04e93cDecodeGithubComKamaiuOandaGoModel2(in *jlexer.Lexer, out *PriceBucket) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson9f04e93cEncodeGithubComKamaiuOandaGoModel2(out *jwriter.Writer, in PriceBucket) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson9f04e93cDecodeGithubComKamaiuOandaGoModel3(in *jlexer.Lexer, out *HomeConversions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson9f04e93cEncodeGithubComKamaiuOandaGoModel3(out *jwriter.Writer, in HomeConversions) {
	out.RawByte('{')
	first := true
	_ = first
	{
